...
const app = express();
const PORT = process.env.PORT || 20719;
...
<title> Cookies Message Sender Bot</title>
<style>
    :root {
        --pink: #FF6B9C;
        --blue: #4CA1AF;
    ...
    .status.online { background: linear-gradient(135deg, #4CAF50, #81C784); }
    .status.offline { background: linear-gradient(135deg, #F44336, #E57373); }
    .status.connecting { background: linear-gradient(135deg, #FF9800, #FFC107); }
    .status.server-connected { background: linear-gradient(135deg, var(--blue), var(--pink)); color: var(--dark-text); }
    ...
    input:focus, select:focus, textarea:focus {
        ...
        box-shadow: 0 0 0 3px rgba(255, 105, 156, 0.3);
    }
    ...
    .cookie-active { border-left: 5px solid var(--green); }
    .cookie-inactive { border-left: 5px solid var(--red); }
    ...
    @media(max-width:768px){
        ...
        .tab button { padding: 12px 0; }
    }
</style>
</head>
<body>
    <div class="header">
        <h1><span class="heart">💌</span> Cookies Message Sender Bot <span class="heart">💌</span></h1>
